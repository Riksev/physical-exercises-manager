   ...
   return !isHistoryOpen ? (
      <div className="app-page">
         ...
         <div className="flex w-full flex-col items-center gap-4">
            ...
            <a
               className="button-full flex items-center justify-center rounded-2xl bg-white font-bold !text-black transition-all delay-200 hover:bg-gray-300 active:bg-gray-300"
