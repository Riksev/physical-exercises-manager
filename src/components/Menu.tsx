...
const Menu = ({
   ...
   const divClasses =
      'flex w-1/3 cursor-pointer flex-col items-center justify-center hover:brightness-70 active:brightness-70'

   return (
      <nav className="flex w-full flex-col items-center bg-gradient-to-br from-fuchsia-900 to-blue-600 p-2 text-center shadow-md">
         <div className="flex h-full w-full flex-row">
            <div
               className={divClasses}
               onClick={(): void => {
                  handleClick(Pages.EXERCISES)
               }}
            >
               <svg
         ...
         <div className="flex h-full w-full flex-row">
            <div
               className={`${divClasses} hover:brightness-100`}
               onClick={(): void => {
                  handleClick(Pages.EXERCISES)
               }}
            >
