   ...
   return (
      <nav className="fixed bottom-0 z-99 flex w-full items-center bg-gradient-to-br from-fuchsia-900 to-blue-600 p-2 shadow-md md:w-3/4 lg:w-1/2">
         ...
         >
            ...
            <p className="text-lg font-bold text-white uppercase">вправи</p>
         </div>
         <div
         ...
         >
            <svg
               xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 448 512"
               className={`mt-1 h-10 w-10 stroke-white stroke-[24] ${activePage === Pages.WORKOUTS ? 'fill-white' : 'fill-transparent'}`}
            >
         ...
         >
            <svg
               xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 576 512"
               className={`mt-1 h-10 w-10 stroke-white stroke-[24] ${activePage === Pages.STATISTICS ? 'fill-white' : 'fill-transparent'}`}
            >
            ...
            <p className="mt-1 text-lg font-bold text-white uppercase">інше</p>
         </div>
      </nav>
   )
}
